...
cap = cv2.VideoCapture(0) #--change this line if you want to install csi camera instead of usb--
...
def check_for_wave(palm_x):
    """Stores movement and checks if hand is waving side-to-side"""
    global wave_history
    curr_time = time.time()
    ...
    if not active_mode:
        ...
        if result.multi_hand_landmarks:
            ...
            if check_for_wave(palm_x):
                print("Wave detected! Switching to Active URL...")
